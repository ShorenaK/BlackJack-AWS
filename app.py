...
# app = Flask(__name__)
# blackjack_game = BlackjackGame(app)
...
class BlackjackGame:
    ...
    def start_game(self):
        ...
        Returns:
        jsonify: JSON response with game state.
        ...
        if self.app:
            with self.app.app_context():
                ...
                return jsonify({
                    ...
                    'PLAYER_NAME': self.PLAYER['name'],
                    'PLAYER_CHIPS': self.PLAYER['chips'],
                    'HTML_CONTENT': render_template('index.html', message=self.MESSAGE, messageDl=self.MESSAGE_DL,
                                                    totalPl=total_pl_tag, totalDl=total_dl_tag),
                })
        else:
            # Return response without HTML content.
            return jsonify({
                'CARD_DECK_Pl': self.CARD_DECK_Pl,
                'CARD_DECK_Dl': self.CARD_DECK_Dl,
                'SUM_DL_CARDS': self.SUM_DL_CARDS,
